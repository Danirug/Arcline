      ...
      <Container className="py-20 md:py-28 lg:py-32">
        <div className="mb-16 max-w-2xl md:mb-20">
          ...
          <h2
            ...
            className="mt-5 text-balance text-[clamp(1.75rem,3.5vw,2.75rem)] font-medium leading-[1.1] tracking-[-0.03em] text-carbon"
          >
        ...
        <div className="divide-y divide-soft-grey border-y border-soft-grey">
          {services.map((service) => (
            ...
            >
              <p
                data-service-number
                className="font-mono text-xs tracking-wider text-slate"
              >
                {service.number}
              </p>

              <div data-service-body className="space-y-3">
              ...
              <ul data-service-details className="space-y-2.5 md:pt-1">
